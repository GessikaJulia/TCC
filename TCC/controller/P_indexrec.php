        ...
        <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                      <a href="P_internações-uti_leitosrec.php"><img src="../imagens/icone-uti.png" width="100px"></a>
                      <br>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                      <br>
                      <a href="P_escalarec.php"><img src="../imagens/icone-escala_medico.png" width="100px"></a>
                      <br>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                      <br>
                      <a href="P_consulta.php"><img src="../imagens/icone-escala_consulta.png" width="100px"></a>
                      <br>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                      <br>
                      <a href="P_cadastro_Paciente.php"><img  src="../imagens/icone-cadastro_paciente.png" width="100px"></a>
                      <br>
